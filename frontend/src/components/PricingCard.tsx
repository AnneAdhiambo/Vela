...
export default function PricingCard({
  ...
  const handlePurchase = () => {
    ...
    // Use the checkout link directly
    // Replace with your actual checkout link from Polar dashboard
    const checkoutLink = 'https://buy.polar.sh/polar_cl_7gbn0wnpw8KwmmB7dXFobxyKGfYU7nStVM9SL1q2Wwm'
